...
export function EmailMarketing() {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      html = html.replace(/{{RESTAURANT_NAME}}/g, restaurantConfig?.name || 'Restaurant Babylon');
      html = html.replace(/{{RESTAURANT_ADDRESS}}/g, branch?.address?.street || (branch?.address as any) || 'Lahti, Finland');
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            ...
            <div className="bg-white rounded border overflow-hidden max-w-[600px] mx-auto shadow-lg">
              <div className="bg-black text-white p-8 text-center">
                <img 
                  src={(restaurantConfig?.logo as any)?.imageUrl || 'https://ravintolababylon.fi/wp-content/uploads/2023/06/logo-header-01.webp'}
                  alt="Restaurant Logo" 
              ...
              <div className="bg-gray-100 p-6 text-center border-t">
                <p className="font-bold text-gray-900 mb-2">{restaurantConfig?.name || 'Restaurant Babylon'}</p>
