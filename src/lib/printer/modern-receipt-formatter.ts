...
export class ModernReceiptFormatter {
  ...
  public static generate(receiptData: ReceiptData, originalOrder?: any): Uint8Array {
    ...
    try {
      ...
      // ═══════════════════════════════════════
      formatter.size(2, 2);
      formatter.text('RAVINTOLA');
      formatter.newLine();
      formatter.size(1, 1);
      formatter.newLine();
      formatter.text('Vapaudenkatu 28');
      formatter.newLine();
      formatter.text('15140 Lahti');
      formatter.newLine();
      formatter.text('+358-3781-2222');
      formatter.newLine(2);
      ...
      formatter.newLine(2);
      formatter.text('ravintolababylon.fi');
      formatter.newLine(3);
